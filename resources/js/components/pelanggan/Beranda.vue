<template>
  <div>
    ...
    <div class="container">
        <br><br><br>
        <div>
          <b-img src="https://static-id.zacdn.com/cms/cw25/996x250_NA_MEN.jpg" fluid-grow alt="Fluid-grow image"></b-img>
        </div>
        <br><br><br>
        <div class="row">
            ...
            <div class="col-md-4" v-for="data in users" :key="data.id">
                <div class="card mb-4">
                    ...
                    <h5 class="card-title text-danger">Rp {{data.harga}}</h5>
                    <p class="card-text">{{data.deskripsi}}</p>
                        <!-- <router-link :to="'/selengkapnya/'+data.id">selengkapnya</router-link> -->
                        <b-button class="success" v-b-toggle.sidebar-backdrop v-on:click="getSelengkapnya(data.id)">Selengkapnya</b-button>
                    </div>
                </div>
            </div>
